...
//        }
	...
	public @ResponseBody List<String> queryYear(@RequestParam("cate") String cate, @RequestParam("token") String token)
			throws Exception {
...
//        }
	...
	public @ResponseBody List<String> queryStandard(@RequestParam("cate") String cate,
			@RequestParam("year") String year, @RequestParam("token") String token) throws Exception {
//        if(!token.equals(md5(cate))){
//            List<String> b = new ArrayList<String>();
//            b.add("205");
//            return b;
//        }
	...
	public @ResponseBody List<String> queryCondition(@RequestParam("cate") String cate,
			@RequestParam("year") String year, @RequestParam("standard") String standard,
...
//        }
	...
	public @ResponseBody List<String> queryPackaged(@RequestParam("cate") String cate,
			@RequestParam("year") String year, @RequestParam("standard") String standard,
			@RequestParam("condition") String condition, @RequestParam("token") String token) throws Exception {
...
//        }
	...
	public @ResponseBody List<String> queryCertificate(@RequestParam("cate") String cate,
			@RequestParam("year") String year, @RequestParam("standard") String standard,
			@RequestParam("condition") String condition, @RequestParam("packaged") String packaged,
			@RequestParam("token") String token) throws Exception {
...
//        }
	...
	public @ResponseBody String queryPrice(@RequestParam("cate") String cate, @RequestParam("year") String year,

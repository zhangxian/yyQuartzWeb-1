...
public interface MayCurExpenseDetailRootMapper {
    ...
    int updateByExampleSelective(@Param("record") MayCurExpenseDetailRootWithBLOBs record, @Param("example") MayCurExpenseDetailRootExample example);

    int updateByExampleWithBLOBs(@Param("record") MayCurExpenseDetailRootWithBLOBs record, @Param("example") MayCurExpenseDetailRootExample example);

    int updateByExample(@Param("record") MayCurExpenseDetailRoot record, @Param("example") MayCurExpenseDetailRootExample example);

...
public interface MayCurCorpRepaymentDetailRootMapper {
    ...
    int updateByExampleSelective(@Param("record") MayCurCorpRepaymentDetailRootWithBLOBs record, @Param("example") MayCurCorpRepaymentDetailRootExample example);

    int updateByExampleWithBLOBs(@Param("record") MayCurCorpRepaymentDetailRootWithBLOBs record, @Param("example") MayCurCorpRepaymentDetailRootExample example);

    int updateByExample(@Param("record") MayCurCorpRepaymentDetailRoot record, @Param("example") MayCurCorpRepaymentDetailRootExample example);

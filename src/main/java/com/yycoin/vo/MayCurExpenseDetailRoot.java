...
public class MayCurExpenseDetailRoot {
    ...
    private String invoicefree;

    private String auditfree;
    ...
    public String getInvoicefree() {
        return invoicefree;
    }

    public void setInvoicefree(String invoicefree) {
        this.invoicefree = invoicefree == null ? null : invoicefree.trim();
    }

    public String getAuditfree() {
        return auditfree;
    }

    public void setAuditfree(String auditfree) {
        this.auditfree = auditfree == null ? null : auditfree.trim();
    }

...
public class MayCurRepaymentDetailRoot {
    ...
    public void setFormsubtype(String formsubtype) {
        this.formsubtype = formsubtype == null ? null : formsubtype.trim();
    }
    ...
    public void setCollectioncurrency(String collectioncurrency) {
        this.collectioncurrency = collectioncurrency == null ? null : collectioncurrency.trim();
    }
    ...
    public void setDepartmentbusinesscode(String departmentbusinesscode) {
        this.departmentbusinesscode = departmentbusinesscode == null ? null : departmentbusinesscode.trim();
    }
    ...
    public void setReimUserCode(String reimUserCode) {
        this.reimUserCode = reimUserCode == null ? null : reimUserCode.trim();
    }
    ...
    public void setReimusername(String reimusername) {
        this.reimusername = reimusername == null ? null : reimusername.trim();
    }
    ...
    public void setSubsidiaryName(String subsidiaryName) {
        this.subsidiaryName = subsidiaryName == null ? null : subsidiaryName.trim();
    }
    ...
    public void setSubmittedat(String submittedat) {
        this.submittedat = submittedat == null ? null : submittedat.trim();
    }
    ...
    public void setApprovedat(String approvedat) {
        this.approvedat = approvedat == null ? null : approvedat.trim();
    }
    ...
    public void setSettledat(String settledat) {
        this.settledat = settledat == null ? null : settledat.trim();
    }
    ...
    public void setModifiedat(String modifiedat) {
        this.modifiedat = modifiedat == null ? null : modifiedat.trim();
    }
    ...
    public void setExportcomments(String exportcomments) {
        this.exportcomments = exportcomments == null ? null : exportcomments.trim();
    }
    ...
    public void setRepaymentaccountname(String repaymentaccountname) {
        this.repaymentaccountname = repaymentaccountname == null ? null : repaymentaccountname.trim();
    }
    ...
    public void setRepaymentaccountcode(String repaymentaccountcode) {
        this.repaymentaccountcode = repaymentaccountcode == null ? null : repaymentaccountcode.trim();
    }
    ...
    public void setRepaymentaccountprovince(String repaymentaccountprovince) {
        this.repaymentaccountprovince = repaymentaccountprovince == null ? null : repaymentaccountprovince.trim();
    }
    ...
    public void setRepaymentaccountcity(String repaymentaccountcity) {
        this.repaymentaccountcity = repaymentaccountcity == null ? null : repaymentaccountcity.trim();
    }
    ...
    public void setRepaymentaccountbranchno(String repaymentaccountbranchno) {
        this.repaymentaccountbranchno = repaymentaccountbranchno == null ? null : repaymentaccountbranchno.trim();
    }
    ...
    public void setRepaymentaccountingsubjectbizcode(String repaymentaccountingsubjectbizcode) {
        this.repaymentaccountingsubjectbizcode = repaymentaccountingsubjectbizcode == null ? null : repaymentaccountingsubjectbizcode.trim();
    }
    ...
    public void setRepaymentaccountingsubjectfullname(String repaymentaccountingsubjectfullname) {
        this.repaymentaccountingsubjectfullname = repaymentaccountingsubjectfullname == null ? null : repaymentaccountingsubjectfullname.trim();
    }
    ...
    public void setRepaymentaccountingsubjectcashflowcode(String repaymentaccountingsubjectcashflowcode) {
        this.repaymentaccountingsubjectcashflowcode = repaymentaccountingsubjectcashflowcode == null ? null : repaymentaccountingsubjectcashflowcode.trim();
    }
    ...
    public void setRepaymentaccountingsubjectcashflowname(String repaymentaccountingsubjectcashflowname) {
        this.repaymentaccountingsubjectcashflowname = repaymentaccountingsubjectcashflowname == null ? null : repaymentaccountingsubjectcashflowname.trim();
    }

    public String getFinanceCodes() {
        return financeCodes;
    }

    public void setFinanceCodes(String financeCodes) {
        this.financeCodes = financeCodes == null ? null : financeCodes.trim();
    }
    ...
    public void setCollectiontobaseexchangerate(String collectiontobaseexchangerate) {
        this.collectiontobaseexchangerate = collectiontobaseexchangerate == null ? null : collectiontobaseexchangerate.trim();
    }

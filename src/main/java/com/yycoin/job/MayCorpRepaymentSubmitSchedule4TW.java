...
@Component
public class MayCorpRepaymentSubmitSchedule4TW implements Job, BaseContants {

	private static Logger logger = LoggerFactory.getLogger(MayCorpRepaymentSubmitSchedule4TW.class);
	...
	@Autowired
	private MayCorpRepaymentSubmitSchedule4TW mayCorpRepaymentSubmitSchedule4TW;
	
	@Override
	public void execute(JobExecutionContext context) throws JobExecutionException {
		try {
			mayCorpRepaymentSubmitSchedule4TW.doo();
		} catch (Exception e) {

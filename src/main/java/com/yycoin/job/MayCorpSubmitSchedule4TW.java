...
@Component
public class MayCorpSubmitSchedule4TW implements Job, BaseContants {

	private static Logger logger = LoggerFactory.getLogger(MayCorpSubmitSchedule4TW.class);
	...
	public void doo()
	{
		...
		for (MayCurCorpSubmit submit : submitList) {
			...
			Message sendMsg = new Message("MayCurTopic", "CorpSubmitTagTw", submit.getReportId().getBytes());
			try {
